...
const Nav = () => {
  ...
  return (
    ...
    <header className='w-full flex bg-[#6374ae] justify-center'>
      ...
      <div onClick={() => { showNav(false) }} id='navBlur' className='fixed top-0 left-0 w-0 h-screen bg-primary-950 bg-opacity-60 transition-all duration-200 delay-[100ms] [backdrop-filter:_blur(2px)]'></div>
      <div id='nav' className='bg-[#e7f0f8] h-screen fixed left-0 w-0 border-r-4 border-t-4 border-b-4 border-[#6374ae] transition-all duration-500 overflow-hidden'>

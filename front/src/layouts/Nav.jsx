...
const Nav = () => {
  ...
  return (
    ...
    <div className='w-full flex relative bg-[#6374ae]'>
      <section className='flex w-full justify-around items-center px-5 py-5'>
        ...
        <h1 className='text-2xl w-[200px] text-[#e7f0f8]'>Administrador de usuarios</h1>
      </section>
      <div id='nav' className='bg-[#e7f0f8] h-screen fixed w-0 border-r-4 border-t-4 border-b-4 border-[#6374ae] transition-all duration-1000 overflow-hidden'>
        ...
        <ul className='pt-24 px-8 flex flex-col gap-7 text-[#6374ae] text-xl font-light'>
          <li className=' h-[38px] text-ellipsis overflow-hidden cursor-pointer border border-transparent hover:border hover:border-[#6374ae] py-1 pl-3 transition-all duration-300 rounded-md'><Link to={"/add_user"}>Agregar usuario</Link></li>
          <li className=' h-[38px] text-ellipsis overflow-hidden cursor-pointer border border-transparent hover:border hover:border-[#6374ae] py-1 pl-3 transition-all duration-300 rounded-md'>Modificar usuario</li>
          <li className=' h-[38px] text-ellipsis overflow-hidden cursor-pointer border border-transparent hover:border hover:border-[#6374ae] py-1 pl-3 transition-all duration-300 rounded-md'>Eliminar usuario</li>
        </ul>
      </div>
    </div>
  )

...
const Nav = () => {
  ...
  return (
    ...
    <header className='w-full flex bg-[#6374ae]'>
      ...
      <div id='nav' className='bg-[#e7f0f8] h-screen fixed w-0 border-r-4 border-t-4 border-b-4 border-[#6374ae] transition-all duration-500 overflow-hidden'>
